...
|-------------+----------------------------------------------------+------------------+-----------------------------------------------------------------|
| PA1415      | [[http://edu.bth.se/utbildning/utb_kursplan.asp?Kurskod=PA1415&RevisionsNr=6&format=pdf][Programvarudesign]]                                  |              7.5 | BSc i Spelprogrammering                                         |
| PA1434      | [[http://edu.bth.se/utbildning/utb_kursplan.asp?Kurskod=PA1434&RevisionsNr=6&format=pdf][Grunder i Objektorienterad Design]]                  |                4 |                                                                 |
...
| PA1443      | [[http://edu.bth.se/utbildning/utb_kursplan.asp?Kurskod=PA1443&RevisionsNr=2&format=pdf][Introduktion till Programvarudesign och Arkitektur]] |                5 | BSc i Programvaruteknik, BSc International Software Engineering |
|-------------+----------------------------------------------------+------------------+-----------------------------------------------------------------|
...
**** Grading    
     I use a /cumulative grading/ scheme in this course. This means that for every assignment you submit, your final grade for the assignments is revised up or down depending on your /total/ performance, but with extra emphasis on your most recent performance.

Let's say that you get a E on the first assignment. The second assignment gets a C, but you have also made an effort to take care of the comments you received on your first assignment in a nice way. So at present, your /cumulative/ grade is a C. For the third assignment, you may confirm your C or improve it by doing a really good job at taking care of past comments as well as the specific topic of the assignment. You may also make a significant error in the third assignment, which will then lower your cumulative grade proportionally. In the end your "scorecard" may look like:

 | Assignment   | Grade | Cumulative Grade | Comment                                                   |
 |--------------+-------+------------------+-----------------------------------------------------------|
 | Assignment 1 | E     | E                |                                                           |
 | Assignment 2 | C     | C                | Improved A1 along with A2                                 |
 | Assignment 3 | E     | D                | Significant flaw in A3, but "rescued" by past performance |
 | Final grade  |       | D                |                                                           |
 |--------------+-------+------------------+-----------------------------------------------------------|

For the courses where you have more than one assignment "moment" in LADOK, the final cumulative grade will be reported on all assignment "moment". For formal reasons, this also means that there is only one submission deadline for all assignments at the end of the course, and all the dates "inside" the course are called /Feedback Deadline/. A Feedback Deadline is a deadline for when you need to submit an assignment in order to get feedback on it, so that you understand how you can improve yourself for the next assignment.
**** Resubmission of Assignments
     IFF you write a /rejoinder/ (see below) you can resubmit Assignment 1 together with Assignments 2 and 3, or at the resubmission dates as outlined below under "Deadlines and Re-Examination". Similarly, Assignment 2 can be resubmitted along with Assigment 3, or at the resubmission dates outlined below. Assignment 3 can only be resubmitted at one of the resubmission dates below, and only if it had a failing grade.
     
     A /rejoinder/ is a separate document where you repeat the feedback you received and exactly what you have done to address that feedback, and point to where this is done in the assignment document(s). You can also make a clear argument for why you disagree with the feedback and why you take no corrective action based on the feedback. By making this document as detailed as possible you make the life of the person marking your assignment so much easier.
*** Written Exam
...
*** Deadlines and Re-Examination
    Assignments:
    1. *Three Week Roll Call*
       Please see the [[./index.org][Start Page for each course]] for more information about the deadline for the three week roll call.
    2. *Feedback Deadlines*
       Please see the [[./index.org][Start Page for each course]] for more information about the assignments and their respective feedback deadlines.
    3. *Assignment Submission*
       <2018-05-25 Fri 08:00> This deadline applies for all assignments.
    4. *First Resubmission*
       <2018-08-30 Thu 08:00> This deadline applies for all assignments unless otherwise agreed with the person marking the assignments and/or the examiner of the course.
    5. *Second Resubmission*
       <2019-03-26 Tue 08:00> This deadline applies for all assignments unless otherwise agreed with the person marking the assignments and/or the examiner of the course.
...
** (Optional) Create Infrastructure
   *Introduction.* In your future career you are going to use configuration management systems such as [[http://svnbook.red-bean.com/][Subversion]] or [[https://git-scm.com/][Git]], so why not start already now? This gives you an easy way to share work between your colleagues, and opens up for me to review your work even before you have submitted it.
   ...
   If you also write your documents in for example [[https://daringfireball.net/projects/markdown/][Markdown]], they are formatted for you by github. Myself, I am partial to [[https://orgmode.org/][Org-mode]] and [[https://www.gnu.org/software/emacs/][Emacs]], especially because of the nice integration with [[http://plantuml.com/][PlantUML]] for generating design diagrams and the excellent export facilities. Org-mode is also nicely supported by github.
   ...
   *More info on Git*
   - [[./git.org][Getting Started with Git -- a mini-tutorial]]
** Sprint Test Plan
...
*** Groups for Seminars
   Some seminars are done online, others are done as a full group. But for /some/ seminars, we would like to divide you in groups, consisting of around 25-30 people per group. Use the following guidelines for an initial rough sort:

   1. Who is the oldest member in your team?
   2. What letter does their family name start with?
   3. Go to the seminar accordingly:

   | Course | Study Programme               | Start Letter | Seminar   |
   |--------+-------------------------------+--------------+-----------|
   | PA1415 | (all)                         | A--N         | Group I   |
   |        |                               | O--Ö         | Group II  |
   |        |                               | (other)      | Group II  |
   |--------+-------------------------------+--------------+-----------|
   | PA1435 | CI Spel och Programvaruteknik | A--N         | Group I   |
   |        |                               | O--Ö         | Group II  |
   |        |                               | (other)      | Group II  |
   |        | CI Industriell Ekonomi        | A--Z + other | Group III |
   |--------+-------------------------------+--------------+-----------|
   | PA1443 | (all)                         | A--Z         | Group I   |
   |        |                               | O--Ö         | Group II  |
   |        |                               | (other)      | Group II  |
   |--------+-------------------------------+--------------+-----------|
...
** Get an Overview of the Assignments
   Take a look at the [[./AssignmentMap.org][Assignment Map]] to see which assignments are relevant for you and how they are connected to each other.
...
* Sprint Acceptance Tests
  ...
  - You have reviewed the [[./AssignmentMap.org][Assignment Map]] and are clear on what you are expected to submit, and in what order.
