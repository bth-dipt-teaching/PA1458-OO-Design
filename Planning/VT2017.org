...
** Sprint Acceptance Tests
   ...
   - Updated your Sprint Test Plan
   - Updated your Course Backlog   
* TODO Release Sprint: Implementation and Testing	   :A3:PA1415:PA1435:
** About this Sprint
...
* TODO Release Sprint: Testing		:A3:PA1443:noexport:MERGE_WITH_SA_RS:
* TODO Release Sprint: Software Architecture			  :A4:PA1443:
...
|---------+----------------------------------------------------+------------+------------------------------------------------------------|
  ...
  |   3 | PA1443                         | - kunna resonera om och skapa en grundläggande testplan för ett objektorienterat system                                            |
  |     |                                |                                                                                                                                    |
